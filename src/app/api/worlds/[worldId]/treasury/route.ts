...
export async function GET(
    ...
    try {
        ...
        // Resolve ownership — session.user.id may be DB ID or Discord ID
        ...
        if (!isOwner) {
            ...
            if (ownerUser?.discordId === discordId) {
                isOwner = true
            }
        }
        ...
        return NextResponse.json({
            ...
            data: {
                ...
                businessCreationFee: world.businessCreationFee,
                maxBusinessesPerCitizen: world.maxBusinessesPerCitizen,
