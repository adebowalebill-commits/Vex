...
function LoginContent() {
    ...
    return (
        <div style={{
            ...
            background: 'var(--color-bg-primary)', padding: 'var(--space-md)',
            ...
            <div style={{ width: '100%', maxWidth: '400px', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 'var(--space-2xl)' }}>
                    <Link href="/" style={{
                        ...
                        <div style={{
                            width: 44, height: 44, background: 'var(--color-accent)',
                ...
                <div className="glass-card" style={{ padding: 'var(--space-2xl)', textAlign: 'center' }}>
                    ...
                    {error && (
                        <div style={{
                            padding: 'var(--space-md)', background: 'var(--color-error-bg)',
                            border: '1px solid rgba(218,55,60,0.3)', borderRadius: 'var(--radius-lg)',
                            marginBottom: 'var(--space-lg)', color: 'var(--color-error)', fontSize: 'var(--text-sm)',
                        }}>
                    ...
                    <button onClick={handleDiscordLogin} className="btn btn-primary" style={{
                        width: '100%', padding: '14px 20px', fontSize: 'var(--text-base)',
                    ...
                    <p style={{ marginTop: 'var(--space-lg)', fontSize: '11px', color: 'var(--color-text-muted)' }}>
                        By signing in, you agree to our Terms of Service and Privacy Policy.
                    </p>
                </div>

                <div style={{ textAlign: 'center', marginTop: 'var(--space-lg)' }}>
                    <Link href="/" style={{ color: 'var(--color-text-secondary)', fontSize: 'var(--text-sm)' }}>
                        ← Back to Home
                    </Link>
                </div>
            </div>
